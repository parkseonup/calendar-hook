...
import { CalendarData, MonthlyDate, UseCalendarProps } from './useCalendar.type';

export default function useCalendar({ showDate, showFixedNumberOfWeeks, locale }: UseCalendarProps): CalendarData {
